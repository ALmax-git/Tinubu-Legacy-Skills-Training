          ...
          <x-dropdown align="right" width="48">
            ...
            <x-slot name="content">
              ...
              <form method="POST" action="{{ route('logout') }}" x-data>
                ...
                <x-dropdown-link href="{{ route('logout') }}" wire:navigate @click.prevent="$root.submit();">
                  {{ __('Log Out') }}
                </x-dropdown-link>
              </form>
            </x-slot>
    ...
    <div class="border-t border-gray-200 pb-1 pt-4 dark:border-gray-600">
      ...
      <div class="mt-3 space-y-1">
        ...
        <form method="POST" action="{{ route('logout') }}" x-data>
          ...
          <x-responsive-nav-link href="{{ route('logout') }}" wire:navigate @click.prevent="$root.submit();">
            {{ __('Log Out') }}
          </x-responsive-nav-link>
        </form>
        ...
        @if (Laravel\Jetstream\Jetstream::hasTeamFeatures())
          ...
          <!-- Team Settings -->
          <x-responsive-nav-link href="{{ route('teams.show', Auth::user()->currentTeam->id) }}" wire:navigate
